                ...
                right={
                    <>
                        <h1 className=" text-2xl text-gray-300 italic ">
                            <span className="text-2xl text-white px-2">
                                &quot;
                            </span>
                ...
                right={
                    <div className=" space-y-10 text-gray-300">
                        <div className=" space-y-6">
                            ...
                            <p className=" text-xl">
                                Dolami, Inc. is a San Francisco-based startup
                                founded in 2022, specializing in virtual reality
                                (VR) technologies. They develop innovative
                                products like the X MASK, a facial tracking
                                device that mirrors real-life expressions onto
                                VR avatars, and{" "}
                                <Link href={"https://goavatown.com/en"}>
                                    Avatown
                                </Link>
                                , a platform for buying and selling 3D avatars
                                and fashion items. Dolami aims to democratize
                                avatar creation and enhance creative expression
                                in virtual spaces.
                            </p>
                            <p className=" text-xl">
                                ...
                                , a 3D avatar and virtual fashion marketplace. I
                                worked as a Full-Stack Software Engineer, using
                                Next.js, NestJS, and cloud technologies to build
                                scalable and user-friendly features. My work
                                helped improve performance, UX, and backend
                                infrastructure for real-time customization and
                                transactions.
                            </p>
                        </div>
                    </div>
                        ...
                        <div className=" space-y-6">
                            <div className=" space-y-3">
                                ...
                                <ul className=" ml-4">
                                    ...
                                    <li>
                                        Next.js, React, NestJS, Node.js, Express
                                    </li>
                                </ul>
                            </div>
